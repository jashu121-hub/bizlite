    ...
    <div className="space-y-4">
      {needsCount > 0 ? (
        <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
          {needsCount} expense{needsCount === 1 ? '' : 's'} on this page need classification.
          Edit transport expenses to choose Inward, Customer Delivery, or General Transport.
        </div>
      ) : null}
      ...
      <ResponsiveDataTable
        columns={[
          ...
          },
          {
            key: 'amount',
            header: 'Amount',
            cell: (r) => <CurrencyDisplay value={r.amount} currency={currency} />,
          },
        ...
        emptyDescription="Record your first business expense to track costs."
      />
      <PaginationControls
        page={page}
        pageSize={10}
